...
function aboutProgramSource() {
  return [
    ...
    '  base: "San Francisco Bay Area",',
    "  focus: [",
    '    "terminal-first product interfaces",',
    '    "fast prototypes that still feel considered",',
    '    "systems that make complex work feel direct",',
    "  ],",
    "};",
    "",
    "export function about() {",
    '  return "Max builds practical software with sharp interaction design."; ',
    "}",
  ].join("\n");
}
